    ...
    <div class="wrapper">
        ...
        <section class="popular-recipes">   
               <asp:Label ID="lblvoornaam" runat="server" Text="voornaam:"></asp:Label><br>
                <asp:TextBox ID="Tbvoornaam" runat="server"></asp:TextBox><br>
                <asp:Label ID="lblachternaam" runat="server" Text="achternaam:"></asp:Label><br>
                <asp:TextBox ID="Tbachternaam" runat="server"></asp:TextBox><br>
                <asp:Label ID="lblgeboortedatum" runat="server" Text="geboortedatum:"></asp:Label><br>
                <asp:TextBox ID="Tbgeboortedatum" runat="server"></asp:TextBox><br>
                <asp:Label ID="lblgeslacht" runat="server" Text="geslacht:"></asp:Label><br>
                <asp:TextBox ID="Tbgeslacht" runat="server"></asp:TextBox><br>
                ...
                <asp:TextBox ID="Tbww" runat="server" TextMode="Password"></asp:TextBox><br> 
                <br>  
                <br>  
